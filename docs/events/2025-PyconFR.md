...
**Pyconfr** is an event organized by [Afpy](https://www.afpy.org/) once a year, bringing together Python developers and anyone else who wants to discover Python.

I took part in a contribution session for Ansible, where the goal was to try to resolve an issue for any Ansible module. [ansible-collections](https://github.com/ansible-collections/community.general/issues)
...
_**[Nox](https://nox.thea.codes/en/stable/tutorial.html)** is a tool designed to automate testing on multiple Python environments. It is similar to Tox. However, it uses the standard Python file for its configuration._
...
The repository is available here : [Gitlab-nox](https://gitlab.com/littlebigcode/public/atelier-nox-pyconfr-2025)
